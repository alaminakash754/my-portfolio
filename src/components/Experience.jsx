...
const Experience = () => {
    return (
        <div className="bg-gradient-to-r from-blue-950 to-gray-800 mt-10 my-5 space-y-10 w-[650px]">
            <h1 className="uppercase text-4xl text-center font-semibold text-[#a55eea] mt-20">My Services</h1>
            ...
            <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-5 ">
                <div className="border-b-4 border-t-4 border-gray-400 p-3 rounded-md">
                    <div className="flex items-center gap-3">
                        <h2 className="text-lg font-medium text-[#a55eea]">Front-End Development Expertise </h2> <FaConnectdevelop></FaConnectdevelop>
                    </div>
                ...
                <div className="border-b-4 border-t-4 border-[#a55eea] p-3 rounded-lg">
                    <div className="flex items-center gap-3">
                        <h2 className="text-lg font-medium text-[#a55eea]">User Interface (UI) Design </h2> <SiAntdesign></SiAntdesign>
                    </div>
                ...
                <div className="flex items-center gap-3">
                        <h2 className="text-lg font-medium text-[#a55eea]">Performance Optimization</h2> <CgPerformance></CgPerformance>
                    </div>
