  ...
  return (
    ...
    <nav className="nav">
      <ul className="nav__list">
        <a
          href="/"
          className={`nav__link ${activeItem === "home" ? "active" : ""}`}
        ...
        <a
          href="about"
          className={`nav__link ${activeItem === "about" ? "active" : ""}`}
        ...
        <a
          href="contact"
          className={`nav__link ${activeItem === "contact" ? "active" : ""}`}
        ...
        <a
          href="projects"
          className={`nav__link ${activeItem === "projects" ? "active" : ""}`}
